<script lang="ts">
  ...
  import Step5 from '$lib/component/tahapan-component/Step5.svelte';
  import { onMount } from 'svelte';
  import type { PageData } from './$types';
  export let data: PageData;
  let openProfile: boolean = false;

  let showStep1Color = 'stroke-red-500';
  let showStep2 = false;
  let showStep2Color = 'stroke-red-500';
  let showStep5Color = 'stroke-red-500';
  let showStep3Color = 'stroke-red-500';
  let showStep4Color = 'stroke-red-500';
  let showStep6Color = 'stroke-red-500';
  ...
  onMount(async () => {
    ...
    switch (data?.studentdata?.registrationstep_id) {
      case 1:
        showStep1Color = 'stroke-green-400';
        break;
      case 2:
        showStep1Color = 'stroke-green-400';
        showStep2Color = 'stroke-green-400';
        break;
      case 3:
        showStep1Color = 'stroke-green-400';
        showStep2Color = 'stroke-green-400';
        showStep3Color = 'stroke-green-400';
        break;
      case 5:
        showStep1Color = 'stroke-green-400';
        showStep2Color = 'stroke-green-400';
        showStep3Color = 'stroke-green-400';
        showStep4Color = 'stroke-green-400';
        showStep5Color = 'stroke-green-400';
        break; 
    }
  });
          ...
          <div class="min-w-0 flex-1">
            ...
            {#if data?.studentdata?.registrationstep_id >= 2}
              <div class="flex items-center justify-between">
                <button
                  on:click={() => (data?.studentdata?.registrationstep_id >= 2 ? goto('/step-2') : '')}
