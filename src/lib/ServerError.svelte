<script lang="ts">
  ...
  export let title = 'Terjadi kesalahan serius';
  export let description = 'Selalu ada waktu untuk istirahat sejenak. Kami akan kembali saat Anda selesai menikmati kopi Anda.';
  export let image = {
