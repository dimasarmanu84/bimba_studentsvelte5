 ...
 * @return The processed string with hyphens removed and the first letter of each word capitalized.
 */
export function splitAndCapitalize(text) {
 ...
 */
export function metaTitle(pathname, name) {
...
export function metaDescription(pathname, baseDescription) {
    return splitAndCapitalize(pathname)
 ...
 */
export function metaImg(pathname, siteUrl, baseUrl = 'https://open-graph-vercel.vercel.app/api/') {
    return splitAndCapitalize(pathname)
