(function (global, factory) {
	...
	/* src/main/component/Editor.svelte generated by Svelte v4.2.19 */
	...
	function instance($$self, $$props, $$invalidate) {
		...
		let { licenseKey = undefined } = $$props;
		let { channel = '7' } = $$props;
		...
		$$self.$$set = $$props => {
			...
			if ('licenseKey' in $$props) $$invalidate(10, licenseKey = $$props.licenseKey);
			if ('channel' in $$props) $$invalidate(11, channel = $$props.channel);
			if ('scriptSrc' in $$props) $$invalidate(12, scriptSrc = $$props.scriptSrc);
			if ('conf' in $$props) $$invalidate(13, conf = $$props.conf);
			if ('modelEvents' in $$props) $$invalidate(14, modelEvents = $$props.modelEvents);
		...
		$$self.$$.update = () => {
			if ($$self.$$.dirty & /*editorRef, lastVal, value, readonly, readonlyCache, disabled, disablindCache*/ 491936) ;
		};
